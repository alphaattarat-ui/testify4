...
import { AVATARS, KNOWLEDGE_BASES } from "@/app/lib/constants"; // <-- IMPORT KNOWLEDGE_BASES
...
function InteractiveAvatar() {
  ...
  // --- ADDED: Find the name of the selected knowledge base ---
  const selectedKnowledgeBaseName = KNOWLEDGE_BASES.find(kb => kb.id === config.knowledgeId)?.name || "Unknown";
